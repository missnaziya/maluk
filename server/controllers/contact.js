...
console.log("create contact");
  ...
  try {
    const { name, email, message, subject } = req.body;
    console.log("data name, email, message, subject ",name, email, message, subject );
    ...
    const to = "missnaziya24@gmail.com";
    const defaultFrom = process.env.DEFAULT_EMAIL_SENDER
    await sendEmail({
      from: "missnaziya24@gmail.com",       // Customer email
      to: "missnaziya24@gmail.com",        // Admin email
      subject: subject,    // Email subject
      text: message ,   // Email body
      html:   `<html>
      <body style="font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: #f4f4f4;">
    ...
    console.log("After prisma",newContactForm);
